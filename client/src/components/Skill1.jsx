  ...
  return (
    <Container>
      ...
      <div className="container">
        <Box image={webdev}>
          <NavLink to="/sumesh" className="box1">
            Web Development
          </NavLink>
        </Box>
        <Box image={appdev}>
          <div className="box2">App Development</div>
        </Box>{" "}
        <Box image={gamedev}>
          <div className="box2">Game Development</div>
        </Box>{" "}
        <Box image={mldev}>
          <div className="box3">Machine Learning</div>
        </Box>{" "}
        <Box image={deepdev}>
          <div className="box3">Deep Learning</div>
        </Box>{" "}
        <Box image={datascientist}>
          <div className="box4">Data Scientist</div>
        </Box>{" "}
        <Box image={hacker}>
          <div className="box4">Hacking</div>
        </Box>
        <Box image={other}>
          <div className="box4">Other software development</div>
        </Box>
      </div>
    </Container>
  );
