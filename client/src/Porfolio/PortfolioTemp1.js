    ...
    <>
      <Container>
        <div className="left">
          <div className="image">
            <img
              src={`data:${data.photo.contentType};base64, ${Buffer.from(
        ...
        <div className="right">
          ...
          <div className="certification-details block">
            ...
            <div className="cer-organistation">
              Organistation : {data && data?.certification[0]?.cer_organisation}
            </div>
          ...
          <div className="experience block">
            ...
            <div className="role">Role : {data && data?.workexp[0]?.role}</div>
